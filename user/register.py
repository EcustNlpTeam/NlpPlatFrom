...
def register(request):
    ...
    try:
        ...
        UserInfo.objects.create(user_name=user_name, user_id=user_id, pass_word=password, user_token=get_random_str(64), token_last_modified=timezone.now(), task_state=False)
